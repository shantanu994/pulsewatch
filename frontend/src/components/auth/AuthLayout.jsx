    ...
    <div className="relative mt-8 overflow-hidden rounded-xl border border-white/10 bg-ink/70 p-4">
      ...
      <div className="relative h-24">
        <svg
          ...
          role="img"
          aria-label="Decorative uptime signal trace"
        >
          <path
            d="M0 61 C32 61 36 60 57 60 S78 60 95 40 S121 17 142 41 S166 68 188 54 S213 33 232 45 S252 67 279 49 S300 30 323 45 S347 64 366 52 S390 38 440 38"
            fill="none"
            stroke="#3DDC97"
            strokeWidth="2"
          />
          <path
            d="M0 80 C90 80 104 78 159 78 S251 78 310 77 S388 78 440 78"
            fill="none"
            stroke="rgba(139,152,165,0.25)"
            strokeWidth="1"
            strokeDasharray="4 6"
          />
        </svg>
        <div className="absolute bottom-0 left-0 font-mono text-[9px] uppercase tracking-[0.2em] text-slate">
          Recorded signal
        </div>
        ...
        <section className="relative flex flex-col justify-between px-6 pb-8 pt-7 sm:px-10 lg:px-16 lg:py-12">
          ...
          <div className="relative">
            <div className="flex items-center gap-2">
              ...
              <span className="font-display text-lg tracking-[0.12em] text-offwhite">
                PULSEWATCH
              </span>
            </div>
          </div>
          ...
          <div className="relative hidden max-w-xl lg:block">
            <p className="mb-4 font-mono text-[10px] uppercase tracking-[0.24em] text-signal">
          ...
          <p className="relative hidden text-xs text-slate lg:block">
            PulseWatch / Infrastructure visibility, simplified.
          </p>
        </section>
        ...
        <section className="flex items-center px-6 pb-10 pt-6 sm:px-10 lg:px-16 lg:py-12">
          ...
          >
            <div className="mb-8 lg:hidden">
              ...
              <h1 className="font-display text-3xl tracking-tight text-offwhite">
                {title}
              </h1>
